...
<div class="sfcart_product">     
  <form method="post" action="/updatecart">
    <fieldset>
      ...
      <div>
            <label>Escanea y twittea tu pedido</label>
            <img src="http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=http%3A//twitter.com/home%3Fstatus%3D%2540Inmzombie%2520%2523quiero%2520%2523PC<?php echo $product->getCode()?>-1&chld=H|0" alt="codigo-para-twitter"/>
        </div>
    </fieldset>
  </form>
</div>
